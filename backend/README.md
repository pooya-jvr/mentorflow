...
Keep `MENTORFLOW_LLM_ROUTER=false` for Metis direct wrappers. Routing still uses
LangChain locally, while the final educational answer is generated by the LLM.
